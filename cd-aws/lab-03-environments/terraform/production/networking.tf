# ---------------------------------------------------------------------------
# VPC — dedicated to this environment, fully isolated from the other
# environment's VPC (no peering, no shared subnets). This is the network-level
# half of the staging/production isolation; IAM scoping (iam.tf) is the other
# half.
# ---------------------------------------------------------------------------
